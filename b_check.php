...
<table class="check">
<tr>
   <td><h3>Checking the program.</h3></td>
</tr>
<?php
require_once("common.php");
...
echo '<tr><td>'.$y."</tr></td>";
if($y=='ch20'){
  $cmd="cd ".PYTHON_PATH.";python solver20.py -c ".$z;
  exec($cmd);
}
elseif($y=='ch19'){
  $cmd="cd ".PYTHON_PATH.";python solver19.py -c ".$z;
  exec($cmd);
}
$testfile='Upload'.$x.'_'.$z;

$file = fopen(cfd_prefix.'/'.$testfile.'/state.txt', "r") or exit("Unable to open file!");
