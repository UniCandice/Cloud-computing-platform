...
$fcase.= '
	<tr>
		<td>'.$xf.'</td>
		<td><a  href="/b_residual.php?case_id='.$xf.'&fid='.$fid.'" style="text-decoration:none">'.'Residual error'.'</a></td>
		<td><a  href="/b_errlog.php?case_id='.$xf.'&fid='.$fid.'" style="text-decoration:none">'. 'Errlog'.'</a></td>
	</tr>';
}
$fcase.='</table>';
echo $fcase;
