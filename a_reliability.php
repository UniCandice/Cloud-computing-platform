...
$fcase.= '
	<tr>
		<td>'.$qc[Case_name].'</td>
		<td><a  href="/a_reliability.php?case_id='.$qc[Case_name].'&fid='.$fid.'" style="text-decoration:none">'.'Reliability'.'</a></td>
	</tr>';
}
$fcase.='</table>';
echo $fcase;
...
$out_path=$testfile.'/'.$case_id.'/analyse.dat';
echo '<table class="reliablility">';
$file = fopen($out_path, "r") or exit("Unable to open file!");
