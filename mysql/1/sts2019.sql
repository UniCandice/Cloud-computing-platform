...
INSERT INTO `auth_user` VALUES (1,'ssheng','','','822657545@qq.com','pbkdf2_sha256$10000$lpzPH9ZW3f1M$CdD3BFsegE990FtUpwiHr6eSG2WD3OSVqOxEhvyJHbk=',1,1,1,'2015-09-02 06:56:25','2015-08-16 02:30:59');
...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'log entry','admin','logentry'),(8,'solver','cfd','solver'),(9,'case','cfd','case'),(10,'sts','cfd','sts'),(11,'sts19','cfd','sts19');
...
-- Dump completed on 2015-09-06 10:20:42
